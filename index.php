...
<noscript>
    <iframe src="https://www.googletagmanager.com/ns.html?id=GTM-5BB8W2X"
        ...
        <div class="row">
            ...
            <div class="col-lg-8 pt-4 pt-lg-0 content" data-aos="fade-left">
                <p class="line-height-4"><span style="font-size: 2em">D</span>éveloppeur concentré et enthousiaste, avec
                    un intérêt marqué pour le développement de logiciels et l'intelligence artificielle. Grâce à une
                    exposition complète aux concepts sous-jacents et à leur application à divers projets, mon amour pour
                    ces domaines est né.
                    aux concepts sous-jacents et en les appliquant de manière vivante à divers projets, mon amour pour
                    ces domaines s'est concrétisé.
                    Je suis une personne passionnée qui aime construire et appliquer des algorithmes pour résoudre des
                    problèmes industriels concrets.
                </p>
                <div class="row">
                    <div class="col-lg-6">
                        <ul>
                            <!-- <li><i class="icofont-rounded-right"></i> <strong>Birthday:</strong> 12 October 1996</li> -->
                            <li><i class="icofont-rounded-right"></i> <strong>Téléphone / Sms:</strong> +237 699 568 073
                            </li>
                            <li><i class="icofont-rounded-right"></i> <strong>Whatsapp:</strong> +237 699 568 073</li>
                        </ul>
                    </div>
                    <div class="col-lg-6">
                        <ul>
                            <li><i class="icofont-rounded-right"></i> <strong>Ville:</strong> Yaoundé</li>
                            <li><i class="icofont-rounded-right"></i> <strong>Pays:</strong> Cameroun</li>
                            <li><i class="icofont-rounded-right"></i> <strong>Email:</strong> lucchuala@gmail.com</li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-lg-3 col-md-4">
                <div class="icon-box">
                    ...
                    <h3>Développement logicielle</h3>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-lg-12" data-aos="fade-up" style="display: inline-block;">
                ...
                <div class="col-md-4 mt-4 mt-md-0 icon-box" data-aos="fade-up" data-aos-delay="100"
                    ...
                    <img src="assets/img/education/iai.jpg" class="img-fluid" alt="">
                    <!-- <h4 style="text-align:left;"><a href="https://www.asu.edu/" target="_blank" style="color:#12d640">Arizona State University</a><br> </h4> -->
                    <p style="text-align:left;color:#fff;padding: 5px 10px;"><em>Ingénieur en Genie Logicielle</em></p>
                    <h5 style="text-align:left;padding: 0px 10px;">Octobre 2021 - Septembre 2022</h5>
                    <h6 style="text-align:left;color:#fff;padding: 0px 10px;">IAI Cameroun</h6>
                    <ul style="text-align:left;color:#fff;">
                        <li>Administrations de Base de données</li>
                        <li>Développement Web</li>
                        <li>Fonctionnements des Algorithmes</li>
                    </ul>
                </div>
                <div class="col-md-4 mt-4 mt-md-0 icon-box" data-aos="fade-up" data-aos-delay="100"
                     style="padding:0px 0px;padding-bottom: 5px;display: inline-block;">
                    ...
                    <p style="text-align:left;color:#fff;padding: 5px 10px;"><em>Technitiens Informatique</em></p>
                    <h5 style="text-align:left;padding: 0px 10px;">Octobre 2020 - Août 2021</h5>
                    <h6 style="text-align:left;color:#fff;padding: 0px 10px;">IAI Cameroun</h6>
                    <ul style="text-align:left;color:#fff;">
                        <!-- <li>Data Structures &amp; Algorithms</li> -->
                        <li>Système d'administration de base de données</li>
                        <!-- <li>Operating Systems</li> -->
                        <li>Fonctionnement du Web</li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <div class="row portfolio-container" style="position: relative; height: 437.75px;">
                ...
                <div class="col-lg-4 col-md-6 portfolio-item filter-app"
                    ...
                    <div class="portfolio-wrap">
                        <img src="assets/img/certification/nodejs.jpg" class="img-fluid" alt="" height="500">
                        <div class="portfolio-info">
                            <h4> Passez au Full Stack avec Node.js, Express et MongoDB</h4>
                            <div class="portfolio-links">
                                <a href="https://openclassrooms.com/fr/course-certificates/6948932507" target="_blank"
                ...
                <div class="col-lg-4 col-md-6 portfolio-item filter-app"
                    ...
                    <div class="portfolio-wrap">
                        <img src="assets/img/certification/restapi.jpg" class="img-fluid" alt="" height="500">
                        <div class="portfolio-info">
                            <h4> Adoptez les API REST pour vos projets web</h4>
                            <div class="portfolio-links">
                                <a href="https://openclassrooms.com/fr/course-certificates/3612077354" target="_blank"
                                   title="Certificate"><i class="bx bx-link"></i></a>
                            </div>
                        </div>
                    </div>
        ...
        <div class="row">
            <div class="col-lg-12" data-aos="fade-up">
                <div class="col-md-12 mt-4 mt-md-0 icon-box" data-aos="fade-up" data-aos-delay="100">
                    <h4 style="text-align:left;"><a href="https://www.asu.edu/" style="color:#12d640">Kamix</a><br></h4>
                    <h5 style="text-align:left;">January 2023 - Present</h5>
                    <p style="text-align:left;color:#fff"><em>Développeur Web </em></p>
                    <ul style="text-align:left;">
                        <li>Mise en place des technologies et de la documentation du projet.</li>
                        <li>Développement d'une solutions de Sondages.</li>
                        <li>Tester et corriger les bugs.</li>
                        <li>Effectuers des déploiement réguliers sur des serveurs en ligne ...</li>
                    </ul>
                </div>
                <div class="col-md-12 mt-4 mt-md-0 icon-box" data-aos="fade-up" data-aos-delay="100">
                    <h4 style="text-align:left;"><a href="https://www.augmenify.com/"
                                                    style="color:#12d640">Kozao.</a><br></h4>
                    <h5 style="text-align:left;">Novembre 2022 - Decembre 2022</h5>
                    <p style="text-align:left;color:#fff"><em>Stagiaire (Jalios)</em></p>
                    <ul style="text-align:left;">
                        <li>Initiation au Framework <strong>JALIOS</strong>.</li>
                        <li>Création des Gabarit (Jalios)</li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-12 d-flex justify-content-center">
                <ul id="portfolio-flters">
                    ...
                    <li data-filter=".filter-project">Personnels</li>
                </ul>
            </div>
        </div>
...
<section id="skills" class="services">
    <div class="container">
        <div class="section-title">
            <h2 class="mt-2">Compétences</h2>
        </div>
        <div class="row">
            <div class="col-lg-12" data-aos="fade-up">
                <div class="col-md-12 mt-4 mt-md-0 icon-box" data-aos="fade-up" data-aos-delay="100"
                     style="background:#fff">
                    <h4 style="text-align:left;color:#09203a">Langages et Bases de donnees</h4>
                    <p style="text-align:center;">
                        ...
                        <img src="https://www.vectorlogo.zone/logos/postgresql/postgresql-horizontal.svg"
                             alt="vectorlogo.zone" height="50" width="190">
                ...
                <div class="col-md-12 mt-4 mt-md-0 icon-box" data-aos="lefade-up" data-aos-delay="100"
                     style="background:#fff">
                    <h4 style="text-align:left;color:#09203a">Outils</h4>
                    <p style="text-align:left;">
                        ...
                        <img src="https://upload.wikimedia.org/wikipedia/commons/8/80/Logo_Plesk.svg" width="80"
                             alt="vectorlogo.zone">
                    </p>
                </div>
            </div>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-3 mt-4 mt-md-0 icon-box" data-aos="fade-up" data-aos-delay="100">
                <a href="assets/cv_luc.pdf" target="_blank">
            ...
            <div class="col-md-3 mt-4 mt-md-0 icon-box" data-aos="fade-up">
                ...
                <h4 class="title"><a href="https://github.com/Nguemoue/portfolio" target="_blank">Depot du Portfolio</a></h4>
                <p class="description" style="color:#fff;"> Depots Github pour le portfolio.</p>
            </div>
            <div class="col-md-3 mt-4 mt-md-0 icon-box" data-aos="fade-up" data-aos-delay="100">
                <a href="https://techingenious.herokuapp.com/" target="_blank">
                    <div class="icon"><i class="icofont-page"></i></div>
                </a>
                <h4 class="title"><a href="https://luc-dev.site/" target="_blank">Site</a></h4>
                <p class="description" style="color:#fff;">Site Personnel</p>
            </div>
        </div>
    </div>
            ...
            <div class="col-md-6 mt-4 mt-md-0 d-flex align-items-stretch">
                <div class="info-box">
                    ...
                    <div class="social-links">
                        <a href="https://www.linkedin.com/in/nguemoue" target="_blank" class="linkedin"><i
                                    class="bx bxl-linkedin"></i></a>
                        <a href="https://www.github.com/Nguemoue" target="_blank" class="github"><i
                                    class="bx bxl-github"></i></a>
                        <a href="mailto:lucchuala@gmail.com" target="_blank" class="google"><i
...
<script type="text/javascript">
    var typed = new Typed('.typing', {
        strings: ["Developpeur Web", "Developpeur Laravel", "Developpeur Javascript"],
        loop: true,
        typeSpeed: 65,
        backSpeed: 65
    });
